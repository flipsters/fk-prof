...
public final class ApiPathConstants {
  ...
  public static final String BACKEND_GET_APPS = "/apps";
  public static final String BACKEND_GET_CLUSTERS_FOR_APP = "/clusters/:appId";
  public static final String BACKEND_GET_PROCS_FOR_APP_CLUSTER = "/procs/:appId/:clusterId";
  ...
  public static final String LEADER_GET_APPS = LEADER_API_PREFIX + "/apps";
  public static final String LEADER_GET_CLUSTERS_FOR_APP = LEADER_API_PREFIX + "/clusters/:appId";
  public static final String LEADER_GET_PROCS_FOR_APP_CLUSTER = LEADER_API_PREFIX + "/procs/:appId/:clusterId";
