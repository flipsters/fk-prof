...
public final class UserapiApiPathConstants {
    ...
    public static final String CLUSTERS_FOR_APP = "/clusters/:appId";
    public static final String PROCS_FOR_APP_CLUSTER = "/procs/:appId/:clusterId";
    ...
    public static final String POLICY_APPS = LIST_POLICY_API_PREFIX + "/apps";
    public static final String POLICY_CLUSTERS_FOR_APP = LIST_POLICY_API_PREFIX + "/clusters/:appId";
    public static final String POLICY_PROCS_FOR_APP_CLUSTER = LIST_POLICY_API_PREFIX + "/procs/:appId/:clusterId";
